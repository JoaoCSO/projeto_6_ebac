...
import { setPaymentData, setOrderId, goToDelivery, selectCartItems, selectCartTotal, selectDeliveryData } from '../../store/reducers/cart'
            ...
            <Form onSubmit={formik.handleSubmit}>
                <InputGroup>
                    ...
                    <Input
                        ...
                        className={formik.touched.cardOwner && formik.errors.cardOwner ? 'error' : ''}
                    />
                </InputGroup>
                ...
                <div style={{ display: 'flex', gap: '30px' }}>
                    ...
                    <InputGroup style={{ flex: 1 }}>
                        ...
                        <Input
                            ...
                            onChange={formik.handleChange}
                            onBlur={formik.handleBlur}
                            className={formik.touched.cardCode && formik.errors.cardCode ? 'error' : ''}
                        />
                    </InputGroup>
                </div>
                ...
                <div style={{ display: 'flex', gap: '34px' }}>
                    <InputGroup style={{ flex: 1 }}>
                        ...
                        <Input
                            ...
                            onChange={formik.handleChange}
                            onBlur={formik.handleBlur}
                            className={formik.touched.expiresMonth && formik.errors.expiresMonth ? 'error' : ''}
                        />
                    </InputGroup>
                    ...
                    <InputGroup style={{ flex: 1 }}>
                        ...
                        <Input
                            ...
                            onChange={formik.handleChange}
                            onBlur={formik.handleBlur}
                            className={formik.touched.expiresYear && formik.errors.expiresYear ? 'error' : ''}
                        />
                    </InputGroup>
                </div>
